...
function createAnimatedComponent(Component: any): any {
  class AnimatedComponent extends React.Component {
    ...
    setNativeProps(props) {
      var didUpdate = ApplyAnimatedValues.current(this._component, props, this);
      if (didUpdate === false) {
        this.forceUpdate();
      }
    }
    ...
    _attachProps(nextProps) {
      ...
      // forceUpdate.
      var callback = () => {
        const didUpdate = ApplyAnimatedValues.current(this._component, this._propsAnimated.__getAnimatedValue(), this);

        if (this._component.setNativeProps || didUpdate) {
